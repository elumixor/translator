...
export function launchEditor(sourceFilePath: string, targetLangs: string[], translatorToken: string, port: string) {
    ...
    const editor = spawn("node", [editorPath, sourceFilePath, "-l", ...targetLangs, "-t", translatorToken, "-p", port])
